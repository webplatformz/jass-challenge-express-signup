...
const ProfileView = ({user: {email, matrikel, school, degreeProgram, degree, gender, fullname, profile: {url, avatar_url}}}) => {
        ...
        <div>
            <Col sm={9}>
                <Form horizontal>
                    ...
                    </FormGroup>    <FormGroup controlId="formHorizontalEmail">
                        <Col sm={2}>
